<?
/**************************************************************************
    This file: /var/www/html/helhed/dinclude/xml_save_temp.php is part of Helhed Server.
...
?>
<res>
  <success>'<?= unicode($name) ?>' er nu blevet opdateret.</success>
</res>
<? mysql_close($link);
return; 
}
...
?>
<res>
  <success>'<?= unicode($name) ?>' er nu gemt.</success>
</res>
