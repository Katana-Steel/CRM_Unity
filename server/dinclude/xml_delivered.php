<?
/**************************************************************************
    This file: /var/www/html/helhed/dinclude/xml_delivered.php is part of Helhed Server.
...
$t = $r[1];
$del = "Leveret";
$que = "update K_notat set status='I',lev='A',tekst='<b><i>$del d. ".strftime("%e. %b - %Y",time())."</i></b><br />\n";
...
<success>Ordre nr: '<?= $r[0] ?>' er nu markered som leveret.</success>
</res>
