<?php
/**************************************************************************
    This file: ../web/helhed/include/xml_extra_mails.php is part of Helhed Client.
...
break;
case 'S':
$tilb = " Salgsm&aring;let";$msub = "Salgsmål nr: $nr";$dc = "tt";$slg = "salgsm&aring;l";
break;
}
...
?>
 ...
 <success><?php echo unicode("Så er den blevet mail igen"); ?></success>
</res>
